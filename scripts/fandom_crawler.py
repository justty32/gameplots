...
CONFIGS = {
    ...
    "iron_saga": {
        # Kidou Sentai Iron Saga / 機動戰隊 Iron Saga. The wiki is mostly
        # gameplay database material, so keep the narrative-bearing pages:
        # pilots, mecha, events, locations, and faction-tagged pages. Skip
        # parts/items/images/templates and pure rank categories.
        "domain": "ironsaga.fandom.com",
        "work": "Iron_Saga",
        "buckets": [
            ("events", ["Events", "Permanent Events", "Collaboration Events"]),
            ("locations", ["Locations"]),
            ("factions", ["A.C.E. Academy", "Anti-Vaca Alliance",
                           "Babylon Cafe", "Black Dog", "Black Hound",
                           "Bounty Hunter", "Bryne Group", "Curia Machinery",
                           "Dark Continent", "Dimension Beasts",
                           "Dimensional Beasts", "Drifters",
                           "Empire Industries", "Far East", "Flottadam",
                           "G.O.E. Mercenary", "G.O.E. Mercenary Company",
                           "Gram Duchy", "Great Britain Empire",
                           "Great Sand Sea Pirates", "Gungnir Duchy",
                           "Hinomaru", "Key of Solomon",
                           "Kunlun Institution",
                           "Laevateinn Duchy of the Valhalla Alliance",
                           "Mechanical Vatican",
                           "Mechanical Vatican-Tech Eye",
                           "Mechanical Vatican - Institute of War",
                           "Mechanical Vatican - Tech Eye",
                           "Mechanical Vatican - The Scripture Pavilion",
                           "Mediterranean Compound Industrial",
                           "Mirage Cross", "Mjölnir Duchy", "OATH Company",
                           "Quicksand Mercenary Company", "Qujra",
                           "Rattlesnake Sand Thieves", "Rhine Federation",
                           "Science Special Search-Party", "Sea Gigant Pirates",
                           "Solomon's Key", "Solomon Industries",
                           "Spiral Beings", "Star Cluster Alliance",
                           "Steel Battalion Gang",
                           "Superalloy Research Institute", "Sylvan Duchy",
                           "Takahashi Heavy Industry", "Takahashi Jyuukou",
                           "The North", "Tusel", "Tyrfing Grand Duchy",
                           "U.S.F", "U.S.F.", "USF", "Valhalla",
                           "Valhalla Alliance", "Valhalla Union"]),
            ("pilots", ["Pilot", "Characters"]),
            ("mechas", ["Mechas", "Collab Mecha", "Collaboration Mecha",
                        "Aircraft", "Land Vehicles", "Tanks"]),
            ("quests", ["Quests", "Episodes"]),
        ],
    },
    "gundam": {
        # Gundam Wiki is very large and heavily mixed with Gunpla/merchandise
        # pages. This config keeps franchise narrative entities across the
        # major animated timelines: characters, factions, conflicts, places,
        # mobile weapons, ships, and in-universe technologies/terms. It
        # intentionally skips merchandise/model-kit/image/game-stat categories.
        "domain": "gundam.fandom.com",
        "work": "Gundam",
        "buckets": [
            ("conflicts", ["Universal Century Conflicts",
                           "Cosmic Era Conflicts", "Cosmic Era conflicts",
                           "After Colony Conflicts", "Anno Domini Conflicts",
                           "Ad Stella Conflicts", "Post Disaster Conflicts",
                           "Future Century Gundam Fights",
                           "After War Conflicts", "Advanced Generation Conflicts",
                           "Regild Century Conflicts", "Conflicts"]),
            ("factions", ["Universal Century Factions",
                           "Universal Century factions", "Cosmic Era Factions",
                           "Cosmic Era factions", "After Colony Factions",
                           "After Colony factions", "Anno Domini Factions",
                           "Ad Stella Factions", "Post Disaster Factions",
                           "Future Century Factions", "After War Factions",
                           "Correct Century Factions",
                           "Advanced Generation Factions",
                           "Regild Century Factions", "Factions"]),
            ("places", ["Universal Century Locations",
                        "Cosmic Era Locations", "Cosmic Era locations",
                        "After Colony Locations", "After Colony locations",
                        "Anno Domini Locations", "Ad Stella Locations",
                        "Post Disaster Locations", "Future Century Locations",
                        "After War Locations", "Correct Century Locations",
                        "Advanced Generation Locations",
                        "Regild Century Locations"]),
            ("technology_items", ["Universal Century Technology",
                                  "Universal Century Terminology",
                                  "Universal Century Items",
                                  ...
                                  "Anno Domini Terminology",
                                  "Ad Stella Technology",
                                  "Ad Stella Terminology",
                                  "Ad Stella Items",
                                  "Post Disaster Technology",
                                  "After War Technology",
                                  "After War Terminology",
                                  "Correct Century Technology",
                                  "Advanced Generation Technology",
                                  "Advanced Generation Terminology",
                                  "Regild Century Technology",
                                  "Gundam Frames"]),
            ("ships", ["Universal Century Ships", "Cosmic Era Ships",
                       "Cosmic Era Ships and Vehicles",
                       "Anno Domini Ships and Spacecraft",
                       "Archangel Corps Ships and Vehicles",
                       "Clyne Faction Ships and Vehicles",
                       "Compass Ships and Vehicles",
                       "Earth Alliance Ships and Vehicles"]),
            ("mobile_weapons", ["Gundams", "Gundam Exia",
                                "Gundam Team Mobile Weapons"]),
            ("characters", ["Universal Century characters",
                            "Cosmic Era Characters", "Cosmic Era characters",
                            "After Colony Characters",
                            "After Colony characters",
                            "Anno Domini characters",
                            "Ad Stella characters",
                            "Post Disaster characters",
                            "Future Century Characters",
                            "Future Century characters",
                            "After War Characters", "After War characters",
                            "Correct Century Characters",
                            "Correct Century characters",
                            "Advanced Generation Characters",
                            "Advanced Generation characters",
                            "Regild Century characters", "Protagonists"]),
        ],
    },
    "pacific_rim": {
        # Pacific Rim franchise: films, comics, and The Black. Keep narrative
        # entities and setting mechanics; skip images, toys, merchandise, and
        # production/real-life categories.
        "domain": "pacificrim.fandom.com",
        "work": "Pacific_Rim",
        "buckets": [
            ("characters", ["Characters", "Characters (Pacific Rim)",
                            "Characters (Uprising)",
                            "Characters (The Black)", "Rangers", "Cadets",
                            "Civilians", "Marshals", "Crew", "Crew (Uprising)",
                            "Black Market Dealers", "Kaiju Cultists"]),
            ("jaegers", ["Jaegers", "Jaegers (Pacific Rim)",
                         "Jaegers (Uprising)", "Jaegers (The Black)",
                         "Rogue Jaegers", "Mark-1", "Mark-2", "Mark-3",
                         "Mark-4", "Mark-5", "Mark-6", "Mark-7",
                         "Mark Classification Unknown"]),
            ("kaiju", ["Kaiju", "Kaiju (Pacific Rim)", "Kaiju (Uprising)",
                       "Kaiju (The Black)", "Kaiju Hybrids",
                       "Kaiju with no Category", "Category I", "Category II",
                       "Category III", "Category IV", "Category V",
                       "Category VI", "Category VII", "Animals"]),
            ("conflicts_timeline", ["Conflicts", "Timeline", "K day",
                                    "Scissure"]),
            ("places", ["Locations", "Locations (Pacific Rim)",
                        "Locations (Uprising)", "Locations (The Black)",
                        "Anteverse", "Breach", "Shatterdome Images"]),
            ("factions", ["Organisations", "Organisation", "Organization",
                          "Pan Pacific Defense Corps", "Shao Industries",
                          "United Nations members", "Members of Bogan"]),
            ("tech_items", ["Lore", "Jaeger Tech", "Jaeger Tech (Uprising)",
                            "Jaeger Tech (The Black)", "Weapons", "Vehicles",
                            "Ships", "Blueprints", "Kaiju Blue",
                            "Drift", "Conn-Pod Images"]),
            ("works", ["Pacific Rim", "Pacific Rim (film)",
                       "Pacific Rim: Uprising", "Pacific Rim Uprising",
                       "Pacific Rim: The Black", "Tales From Year Zero",
                       "Tales From The Drift", "Pacific Rim: Aftermath",
                       "Pacific Rim Uprising: Ascension",
                       "Pacific Rim: Blackout", "Pacific Rim: Final Breach",
                       "Pacific Rim: Amara", "Pacific Rim: Training Day"]),
        ],
    },
    "pillars_of_eternity": {
